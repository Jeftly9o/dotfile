...
tools
sudo pacman -S nmap wireshark-qt tcpdump burpsuite metasploit \
aircrack-ng wifite hashcat john hydra sqlmap wfuzz gobuster \
dirsearch ghidra radare2 exploitdb nikto bettercap proxychains-ng \
whatweb subfinder assetfinder

fonts
sudo pacman -S ttf-jetbrains-mono-nerd ttf-hack-nerd ttf-nerd-fonts-symbols \
ttf-nerd-fonts-symbols-mono noto-fonts noto-fonts-emoji noto-fonts-cjk

paru -S visual-studio-code-bin brave-bin heroic-games-launcher-bin \
cmatrix peaclock
